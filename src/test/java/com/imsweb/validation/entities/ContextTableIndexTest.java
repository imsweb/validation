...
public class ContextTableIndexTest {
    ...
    public void testFind() {
        ...
        Assert.assertEquals(1, idx1.find("v1"));
        Assert.assertEquals(2, idx1.find(" 1"));
        Assert.assertEquals(3, idx1.find("v "));
        ...
        Assert.assertEquals(1, idx2.find("v3"));
        Assert.assertEquals(2, idx2.find(" 3"));
        ...
        Assert.assertEquals(1, idx3.find("v1v3"));
        Assert.assertEquals(2, idx3.find(" 1 3"));
        Assert.assertEquals(3, idx3.find("v v3"));
        ...
        Assert.assertEquals(1, idx4.find("v1v2v3"));
        Assert.assertEquals(2, idx4.find(" 1 2 3"));
        Assert.assertEquals(3, idx4.find("v v v3"));
    }
    ...
    public void testFindFloor() {
        ...
        Assert.assertEquals(1, idx1.findFloor("b1"));
        Assert.assertEquals(1, idx1.findFloor("c1"));
        Assert.assertEquals(2, idx1.findFloor("d1"));
        Assert.assertEquals(2, idx1.findFloor("e1"));
        Assert.assertEquals(3, idx1.findFloor("f1"));
        Assert.assertEquals(3, idx1.findFloor("g1"));
        ...
        Assert.assertEquals(2, idx2.findFloor("c3"));
        Assert.assertEquals(2, idx2.findFloor("e3"));
        Assert.assertEquals(3, idx2.findFloor("f3"));
        Assert.assertEquals(3, idx2.findFloor("g3"));

        ContextTableIndex idx3 = new ContextTableIndex("idx3",  table, Arrays.asList("header1", "header3"));
        Assert.assertTrue(idx3.hasUniqueKeys());
        Assert.assertEquals(-1, idx3.findFloor("a1  "));
        Assert.assertEquals(-1, idx3.findFloor("b1b2"));
        Assert.assertEquals(1, idx3.findFloor("b1b3"));
        Assert.assertEquals(1, idx3.findFloor("c1b3"));
        Assert.assertEquals(2, idx3.findFloor("d1b3"));
        Assert.assertEquals(2, idx3.findFloor("e1e3"));
        Assert.assertEquals(3, idx3.findFloor("f1f3"));
        Assert.assertEquals(3, idx3.findFloor("g1g3"));
    }
}
