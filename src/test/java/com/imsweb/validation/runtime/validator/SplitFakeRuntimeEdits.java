...
public class SplitFakeRuntimeEdits implements RuntimeEdits {

    public static Validator getValidator() {
        try {
            return ValidationXmlUtils.loadValidatorFromXml(getXmlUrl(), new SplitFakeRuntimeEdits());
        }
        catch (IOException e) {
    ...
    public CompiledRules getCompiledRules() {
        return new CompiledRulesBundle(new SplitFakeRuntimeEditsCompiledRules1(), new SplitFakeRuntimeEditsCompiledRules2());
    }
